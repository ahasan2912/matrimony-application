...
import { usePeopleLikedMeQuery } from '../../../../features/intraction/likeApi';

const Likedme = () => {
    const { user } = useSelector((state) => state.auth);

    const { data: receivedLikesData, isLoading } = usePeopleLikedMeQuery({
        ...
        <div>
            <section>
                <div className="flex items-center gap-2 mb-1">
                    <h2 className="text-xl sm:text-2xl font-bold text-[#58001C]">People I Liked</h2>
