        ...
        <div className="max-w-7xl mx-auto bg-white rounded-[20px] flex flex-col md:flex-row gap-8 text-gray-800 my-12.5 px-4">
            <div className="w-full md:w-1/3">
                ...
                <div className="flex gap-5 items-center mt-6 ">
                    <button className="w-14 h-14 rounded-full bg-gray-500 text-white flex items-center justify-center hover:scale-110 transition-transform"><X size={28} /></button>
                    <button className="w-14 h-14 rounded-full bg-amber-400 text-white flex items-center justify-center hover:scale-110 transition-transform"><RotateCcw size={28} /></button>
                    <button className="w-14 h-14 rounded-full bg-cyan-400 text-white flex items-center justify-center hover:scale-110 transition-transform"><MessageCircle size={28} /></button>
                    <button className="w-14 h-14 rounded-full bg-[#c2004d] text-white flex items-center justify-center hover:scale-110 transition-transform shadow-lg shadow-rose-200"><Heart size={28} fill="currentColor" /></button>
                </div>
            </div>
